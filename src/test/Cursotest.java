...
public class Cursotest {
	...
	public void setUp() throws Exception {
		cursos = new Curso("Info", "Programação", "LB02", "RS56677TU", "Pendrive", 129, 210.90);
		copia = new Curso("Info", "Programação", "LB02", "RS56677TU", "Pendrive", 129, 210.90);
	}
	
	@Test
	public void test00Carregar() {
	
		Curso fixture = new Curso("Info", "Programação", "LB02", "RS56677TU", "Pendrive", 129, 210.90);
		Curso novo = new Curso (null,null,null,null,null,123,123.333);
		novo.consultar();
